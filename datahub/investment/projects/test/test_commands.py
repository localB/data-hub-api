...
from datahub.investment.projects.constants import FEATURE_FLAG_STREAMLINED_FLOW
from datahub.investment.projects.management.commands import activate_streamlined_investment_flow
from datahub.investment.projects.test.factories import (
...
class TestActivateStreamlinedInvestmentFlowCommand:
    ...
    @mock.patch('datahub.investment.projects.management.commands.'
