...
from datahub.investment.projects.evidence.urls import urlpatterns as evidence_urlpatterns
from datahub.investment.projects.proposition.urls import urlpatterns as proposition_urlpatterns
from datahub.investment.projects.views import (
