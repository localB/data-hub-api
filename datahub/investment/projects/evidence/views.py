...
from datahub.investment.projects.evidence.models import EvidenceDocument
from datahub.investment.projects.evidence.permissions import (
    EvidenceDocumentModelPermissions,
    IsAssociatedToInvestmentProjectEvidenceDocumentPermission,
)
from datahub.investment.projects.evidence.serializers import EvidenceDocumentSerializer
