...
from datahub.investment.projects.models import InvestmentProject as DBInvestmentProject
from datahub.investment.projects.query_utils import get_project_code_expression
