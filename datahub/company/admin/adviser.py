...
from datahub.company.admin.adviser_forms import AddAdviserFromSSO
...
class AddAdviserFromSSOAdmin(AdviserAdmin):
    ...
    add_form_template = 'admin/company/advisor/add_sso_adviser.html'
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
            'fields': ('search_email',),
