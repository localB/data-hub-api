...
LOCAL_APPS = [
    ...
    'datahub.interaction',
    'datahub.investment.projects.apps.InvestmentConfig',
    'datahub.investment.projects.evidence.apps.InvestmentEvidenceConfig',
    'datahub.investment.projects.proposition.apps.InvestmentPropositionConfig',
    'datahub.investment.projects.report.apps.InvestmentReportConfig',
    'datahub.metadata',
    'datahub.oauth',
